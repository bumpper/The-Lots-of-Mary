# Cross-Platform Build Instructions for Lots of Mary

This guide provides detailed instructions for building the Lots of Mary application on Windows, macOS, and Linux (including Fedora for RPM packages).
...
The Lots of Mary application is built using Tauri 2.0, which allows you to create native desktop applications for multiple platforms. However, **you must build on each target platform** - cross-compilation from Windows to macOS/Linux is not straightforward with Tauri.
...
- **MSI Installer:** `src-tauri\target\release\bundle\msi\lots-of-mary_1.0.0_x64_en-US.msi`
- **NSIS Installer:** `src-tauri\target\release\bundle\nsis\lots-of-mary_1.0.0_x64-setup.exe`
- **Executable:** `src-tauri\target\release\lots-of-mary.exe`
...
- **DMG Installer:** `src-tauri/target/release/bundle/dmg/lots-of-mary_1.0.0_aarch64.dmg`
- **App Bundle:** `src-tauri/target/release/bundle/macos/Lots-of-Mary.app`
...
codesign --force --deep --sign "Developer ID Application: Your Name" \
  src-tauri/target/release/bundle/macos/Lots-of-Mary.app

# Verify signature
codesign --verify --verbose src-tauri/target/release/bundle/macos/Lots-of-Mary.app
```
...
- **DEB Package:** `src-tauri/target/release/bundle/deb/lots-of-mary_1.0.0_amd64.deb`
- **AppImage:** `src-tauri/target/release/bundle/appimage/lots-of-mary_1.0.0_amd64.AppImage`

### Installing the DEB Package

```bash
sudo dpkg -i src-tauri/target/release/bundle/deb/lots-of-mary_1.0.0_amd64.deb
```
...
- **RPM Package:** `src-tauri/target/release/bundle/rpm/lots-of-mary-1.0.0-1.x86_64.rpm`
- **AppImage:** `src-tauri/target/release/bundle/appimage/lots-of-mary_1.0.0_amd64.AppImage`

### Installing the RPM Package

```bash
sudo dnf install src-tauri/target/release/bundle/rpm/lots-of-mary-1.0.0-1.x86_64.rpm
```

Or using rpm directly:

```bash
sudo rpm -i src-tauri/target/release/bundle/rpm/lots-of-mary-1.0.0-1.x86_64.rpm
```
